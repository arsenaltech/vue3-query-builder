...
(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("vue")) : typeof define === "function" && define.amd ? define(["exports", "vue"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2.QueryBuilderVue = {}, global2.Vue));
  ...
  const _sfc_main$3 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { emit: emit2 }) {
      ...
      const component = vue.computed(() => definition.value.component);
      const ruleData = vue.computed({
        get: () => props2.query.value,
        set: (update) => {
          ruleUpdate(update);
        }
      });
      const ruleSlotProps = vue.computed(() => ({
      ...
      const showDragHandle = vue.computed(() => {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$2, [
          vue.unref(showDragHandle) ? (vue.openBlock(), vue.createElementBlock("img", _hoisted_2$2)) : vue.createCommentVNode("", true),
          _ctx.$slots.rule ? vue.renderSlot(_ctx.$slots, "rule", vue.normalizeProps(vue.mergeProps({ key: 1 }, vue.unref(ruleSlotProps))), void 0, true) : (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 2 }, [
            vue.createElementVNode("span", {
              class: "query-builder-rule__name",
              textContent: vue.toDisplayString(vue.unref(definition).name)
            }, null, 8, _hoisted_3$2),
            vue.createElementVNode("div", _hoisted_4$1, [
              (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(vue.unref(component)), {
                modelValue: vue.unref(ruleData),
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => vue.isRef(ruleData) ? ruleData.value = $event : null)
              }, null, 8, ["modelValue"]))
            ])
          ], 64))
        ]);
  ...
  const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      const props2 = __props;
      const isRule$1 = vue.computed(() => isRule(props2.query));
      const isRuleSet$1 = vue.computed(() => isRuleSet(props2.query));
      const ruleDefinition = vue.computed(() => {
        if (!isRule$1.value) {
          return null;
        }
        ...
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$1, [
          (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(vue.unref(component)), {
            ...
            vue.renderList(_ctx.$slots, (_, slotName) => {
              return {
                name: slotName,
                fn: vue.withCtx((props22) => [
                  vue.renderSlot(_ctx.$slots, slotName, vue.normalizeProps(vue.guardReactiveProps(props22)), void 0, true)
                ])
              };
            })
  ...
  const _hoisted_7 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("span", { class: "query-builder-group__group-operator" }, "Operator", -1));
  const _hoisted_8 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("option", {
    disabled: "",
    value: ""
  ...
  const _hoisted_14 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "query-builder-group__spacer" }, null, -1));
  const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { expose, emit: emit2 }) {
      ...
      const trap = vue.ref(null);
      const selectedRule = vue.ref("");
      ...
      const childProxies = vue.computed(() => children.value.map((item, index2) => ({
        __item: item,
        __id: index2
      })));
      ...
      const draggableComponent$1 = vue.ref(null);
      ...
      const operators = vue.computed(() => props2.config.operators);
      const suboperators = vue.computed(() => props2.config.suboperators);
      const rules = vue.computed(() => props2.config.rules);
      const childDepth = vue.computed(() => props2.depth + 1);
      const childDepthClass = vue.computed(() => `query-builder-group__group-children--depth-${childDepth.value}`);
      const hasMaxDepth = vue.computed(() => typeof props2.config.maxDepth === "number");
      const maxDepthExeeded = vue.computed(() => {
      ...
      const getBorderStyle = vue.computed(() => {
      ...
      const groupControlSlotProps = vue.computed(() => ({
      ...
      const showDragHandle = vue.computed(() => !(dragOptions.value.disabled || props2.depth === 0));
      function addRule() {
        const childrenUpdate = [...children.value];
      ...
      expose({
        type,
        children,
        depth: vue.computed(() => props2.depth),
        selectedOperator,
        trap
      });
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
          vue.createElementVNode("div", _hoisted_2, [
            _ctx.$slots.groupOperator ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3, [
              vue.unref(showDragHandle) ? (vue.openBlock(), vue.createElementBlock("img", _hoisted_4)) : vue.createCommentVNode("", true),
              vue.renderSlot(_ctx.$slots, "groupOperator", vue.normalizeProps(vue.guardReactiveProps(vue.unref(groupOperatorSlotProps))), void 0, true)
            ])) : (vue.openBlock(), vue.createElementBlock("div", _hoisted_5, [
              vue.unref(showDragHandle) ? (vue.openBlock(), vue.createElementBlock("img", _hoisted_6)) : vue.createCommentVNode("", true),
              _hoisted_7,
              vue.withDirectives(vue.createElementVNode("select", {
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => vue.isRef(selectedOperator) ? selectedOperator.value = $event : null)
              }, [
                _hoisted_8,
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(operators), (operator) => {
                  return vue.openBlock(), vue.createElementBlock("option", {
                    key: operator.identifier,
                    value: operator.identifier,
                    textContent: vue.toDisplayString(operator.name)
                  }, null, 8, _hoisted_9);
                }), 128))
              ], 512), [
          ...
          vue.createVNode(vue.unref(draggableComponent), vue.mergeProps({
            class: ["query-builder-group__group-children", vue.unref(childDepthClass)],
            style: vue.unref(getBorderStyle),
            modelValue: vue.unref(childProxies),
            onChange: updateSort,
            "item-key": "__id",
            tag: "div"
          }, vue.unref(dragOptions), {
            ref_key: "draggableComponent",
            ref: draggableComponent$1
          }), {
            item: vue.withCtx(({ element: child, index: idx }) => [
              (vue.openBlock(), vue.createBlock(QueryBuilderChild, {
                key: idx,
                config: __props.config,
                query: child.__item,
                depth: vue.unref(childDepth),
  ...
  const _sfc_main = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { emit: emit2 }) {
      const props2 = __props;
      vue.provide("getMergeTrap", provideMergeTrap);
      let trap = null;
      vue.watch(() => props2.modelValue, () => {
        trap = null;
      });
      const ruleSet = vue.computed(() => {
      ...
      const queryBuiderConfig = vue.computed(() => {
        if (!props2.config.dragging) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createBlock(QueryBuilderGroup, {
          config: vue.unref(queryBuiderConfig),
          query: vue.unref(ruleSet),
          depth: 0,
